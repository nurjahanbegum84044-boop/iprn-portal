...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        API_URL = "http://187.53.137.91/ints/api/v1/messages?token=k4d22pFq-__0TkbB3Vg_Dy2X1mh3bEiDz_A3PhAh6zQ&limit=500"
        ...
        try:
            ...
            response_data = {"success": True, "messages": filtered_messages}
